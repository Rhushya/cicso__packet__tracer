...
> For ICT, Server Room and each department I have taken 256 host. So that we can increase the number of device if needed.

> For more information check report.

> SSH is enabled only for Finance and Admin.
...
REFERENCE VEDIO [this video](https://www.youtube.com/watch?v=eqEd84yeRxg&t=8s).
